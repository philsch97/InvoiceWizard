...
public partial class BackendApiClient
{
    ...
    private static InvoiceEntity MapInvoice(InvoiceListDto item)
    {
        return new InvoiceEntity
        {
            ...
            RelatedCustomerIds = item.RelatedCustomerIds ?? new List<int>(),
            RelatedCustomerNames = item.RelatedCustomerNames ?? new List<string>(),
            RelatedProjectIds = item.RelatedProjectIds ?? new List<int>(),
            RelatedProjectNames = item.RelatedProjectNames ?? new List<string>(),
    ...
    private class InvoiceListDto { public int InvoiceId { get; set; } public string InvoiceDirection { get; set; } = ""; public string InvoiceStatus { get; set; } = ""; public int? CustomerId { get; set; } public string InvoiceNumber { get; set; } = ""; public DateTime InvoiceDate { get; set; } public DateTime? DeliveryDate { get; set; } public DateTime? PaymentDueDate { get; set; } public string SupplierName { get; set; } = ""; public bool HasSupplierInvoice { get; set; } public string AccountingCategory { get; set; } = ""; public string Subject { get; set; } = ""; public bool ApplySmallBusinessRegulation { get; set; } public decimal InvoiceTotalAmount { get; set; } public decimal ShippingCostNet { get; set; } public decimal ShippingCostGross { get; set; } public string OriginalPdfFileName { get; set; } = ""; public bool HasStoredPdf { get; set; } public DateTime? DraftSavedAt { get; set; } public DateTime? FinalizedAt { get; set; } public DateTime? CancelledAt { get; set; } public string CancellationReason { get; set; } = ""; public string? CustomerName { get; set; } public List<int>? RelatedCustomerIds { get; set; } public List<string>? RelatedCustomerNames { get; set; } public List<int>? RelatedProjectIds { get; set; } public List<string>? RelatedProjectNames { get; set; } }
