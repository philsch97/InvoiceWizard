...
public class BackendApiClient
{
    ...
    public async Task SaveInvoiceAsync(string invoiceNumber, DateTime invoiceDate, string supplierName, string sourcePdfPath, string contentHash, IEnumerable<ManualInvoiceLineInput> lines)
    {
    ...
    {
        var invoice = new InvoiceEntity { InvoiceId = item.InvoiceId, InvoiceNumber = item.InvoiceNumber, InvoiceDate = item.InvoiceDate };
